...
import wiki.wear.openweartools.databinding.FileJobConflictDialogViewBinding
import wiki.wear.openweartools.materialfiles.file.FileItem
import wiki.wear.openweartools.materialfiles.file.fileSize
import wiki.wear.openweartools.materialfiles.file.formatShort
import wiki.wear.openweartools.materialfiles.file.iconRes
import wiki.wear.openweartools.materialfiles.file.lastModifiedInstant
import wiki.wear.openweartools.materialfiles.filelist.supportsThumbnail
...
class FileJobConflictDialogFragment : AppCompatDialogFragment() {
    ...
    /** @see wiki.wear.openweartools.materialfiles.filelist.FileListAdapter.onBindViewHolder */
